...
MySQL - 5.7.17-log : Database - mybatis-template
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mybatis-template` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
insert  into `sys_role`(`id`,`name`,`type`,`status`,`remark`,`operator`,`operate_time`,`operate_ip`) values (1,'产品管理员',1,1,'','Admin','2017-10-15 12:42:47','0:0:0:0:0:0:0:1'),(2,'订单管理员',1,1,'','Admin','2017-10-15 12:18:59','0:0:0:0:0:0:0:1'),(3,'公告管理员',1,1,'','Admin','2017-10-15 12:19:10','0:0:0:0:0:0:0:1'),(4,'权限管理员',1,1,'','Admin','2017-10-15 21:30:36','0:0:0:0:0:0:0:1'),(5,'运维管理员',1,1,'运维','Admin','2017-10-17 00:23:28','0:0:0:0:0:0:0:1');
...
insert  into `sys_role_acl`(`id`,`role_id`,`acl_id`,`operator`,`operate_time`,`operate_ip`) values (9,4,7,'Admin','2017-10-16 23:34:39','0:0:0:0:0:0:0:1'),(10,4,8,'Admin','2017-10-16 23:34:39','0:0:0:0:0:0:0:1'),(11,4,9,'Admin','2017-10-16 23:34:39','0:0:0:0:0:0:0:1'),(12,4,10,'Admin','2017-10-16 23:34:39','0:0:0:0:0:0:0:1');
...
insert  into `sys_role_user`(`id`,`role_id`,`user_id`,`operator`,`operate_time`,`operate_ip`) values (16,4,1,'Admin','2017-10-17 00:24:04','0:0:0:0:0:0:0:1'),(17,4,4,'Admin','2017-10-17 00:24:04','0:0:0:0:0:0:0:1');
